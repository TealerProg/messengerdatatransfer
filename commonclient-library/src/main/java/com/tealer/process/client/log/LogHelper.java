package com.tealer.process.client.log;
...
public class LogHelper {
    private static final String LOG_TAG = "ClientMessageManager";
    ...
    public static void d(String tag, String msg, Object... args) {
        ...
        if(isLoggable(Log.DEBUG)){
            logDelegate.d(LogHelper.LOG_TAG, format(tag,msg, args));
        }
    }
    ...
    public static void i(String tag, String msg, Object... args) {
        ...
        if(isLoggable(Log.INFO)){
            logDelegate.i(LogHelper.LOG_TAG, format(tag,msg, args));
        }
    }
    ...
    public static void w(String tag, String msg, Object... args) {
        ...
        if(isLoggable(Log.WARN)){
            logDelegate.w(LogHelper.LOG_TAG, format(tag,msg, args));
        }
    }
    ...
    public static void e(String tag, String msg, Object... args) {
        ...
        if(isLoggable(Log.ERROR)){
            logDelegate.e(LogHelper.LOG_TAG, format(tag,msg, args),null);
        }
    }
    ...
    public static void e(String tag, String msg, Throwable tr) {
        if (tr == null) return;
        if(isLoggable(Log.ERROR)){
            logDelegate.e(LogHelper.LOG_TAG, format(tag,msg),tr);
        }
    }
    ...
    public static void e(String tag, Throwable tr) {
        if (tr == null) return;
        if(isLoggable(Log.ERROR)){
            logDelegate.e(LogHelper.LOG_TAG, format(tag,null),tr);
        }
    }
